...
### Selection Wrapper Script (Templater)

To wrap the currently selected text in a piped wikilink and position the cursor for typing the note's target name, use this Templater execution script:
